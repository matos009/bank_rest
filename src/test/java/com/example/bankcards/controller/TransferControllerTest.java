...
@AutoConfigureMockMvc(addFilters = false) // фильтры выключены — используем @WithMockUser
class TransferControllerTest {
    ...
    void transfer_ok() throws Exception {
        ...
        given(transfers.transfer(eq(7L), any(TransferRequest.class))).willReturn(resp);
    ...
    void transfer_bad_request_400_from_service() throws Exception {
        ...
        given(transfers.transfer(eq(7L), any(TransferRequest.class)))
